...
fn main() {
    ...
    println!("{}Enter the principal amount (loan amount):", currency_symbol);
    io::stdin()
        .read_line(&mut input)
    ...
    println!("{}Enter the annual interest rate (in %):", currency_symbol);
    io::stdin()
        .read_line(&mut input)
        .expect("Failed to read line");
    ...
    println!("{}Enter the number of months:", currency_symbol);
    io::stdin()
        .read_line(&mut input)
        .expect("Failed to read line");
